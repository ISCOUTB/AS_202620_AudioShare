...
Como nos mensiono el profesor para unos posibles escenarios serian los siguientes:

## Ec1: 
Un dispositivo emisor debe iniciar la reproducción mientras que otro/s dispositivos receptores están conectados a la misma red Wi-Fi
