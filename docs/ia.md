...
| Etapa | Uso | Propósito | Resultado |
|---|---|---|---|
| Semana 1 | Generación y evaluación de ideas | Explorar posibles proyectos para la asignatura | Se seleccionó AudioShare como propuesta de proyecto |
| Semana 1 | Redacción y revisión | Estructurar la ficha del problema | Se definió el problema y el prototipo de AudioShare |
| Semana 2 | Arc42 | Apoyar la organización de las secciones 1–3 | Se estructuró la documentación inicial de arquitectura |
...
el propósito de cada consulta y las modificaciones o decisiones
